...
const activeEffectTargets = new Set(["initiative", "armorClass", "fortitude", "reflex", "will", "attackRolls", "damageRolls", "spellResistance", ...abilities, "allies", "self", "area", "enemy"]);
