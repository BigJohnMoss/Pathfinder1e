...
const bundle={generatedAt:new Date().toISOString(),classes:await loadDir('classes'),races:await loadDir('races'),optionGroups:await loadDir('options'),feats:await loadDir('feats'),spells:await loadDir('spells')};
