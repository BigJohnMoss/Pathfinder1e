...
for (const kind of ["damageReduction", "energyResistance", "spellResistance", "immunity", "evasion", "improvedEvasion"]) console.log(`${kind}: ${runtimeRows.filter((row) => row.adjustment.kind === kind).length}`);
