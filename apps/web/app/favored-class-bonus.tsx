...
export const alternateFavoredClassRewards: AlternateFavoredClassReward[] = [
  ...
  { id: "half-elf-summoner-evolutions", ancestryId: "half-elf", classId: "summoner", label: "Evolution pool", description: "+1/4 point to the eidolon's evolution pool.", divisor: 4 },
  { id: "half-elf-witch-spell", ancestryId: "half-elf", classId: "witch", label: "Familiar spell", description: "Add one eligible witch spell to the familiar." },
  ...
  { id: "half-orc-alchemist-bomb-damage", ancestryId: "half-orc", classId: "alchemist", label: "Bomb damage", description: "+1/2 damage with bombs.", divisor: 2 },
  { id: "half-orc-inquisitor-hunter", ancestryId: "half-orc", classId: "inquisitor", label: "Creature hunter", description: "+1/2 on Intimidate and creature-identification Knowledge checks.", divisor: 2 },
  { id: "half-orc-witch-familiar", ancestryId: "half-orc", classId: "witch", label: "Familiar skill", description: "+1 skill rank to the witch's familiar." },
  ...
  { id: "halfling-summoner-eidolon-skill", ancestryId: "halfling", classId: "summoner", label: "Eidolon skill", description: "+1 skill rank to the summoner's eidolon." },
  ...
  { id: "human-inquisitor-spell", ancestryId: "human", classId: "inquisitor", label: "Spell known", description: "Add one eligible inquisitor spell known." },
  { id: "human-summoner-eidolon", ancestryId: "human", classId: "summoner", label: "Eidolon training", description: "+1 hit point or skill rank to the summoner's eidolon." },
  { id: "human-witch-spell", ancestryId: "human", classId: "witch", label: "Familiar spell", description: "Add one eligible witch spell to the familiar." },
