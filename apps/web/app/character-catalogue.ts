...
export const optionGroups = orderedById<CharacterOptionGroup>(generatedData.optionGroups, ["arcanist-exploits", "rage-powers", "brutal-pugilist-maneuvers", "invulnerable-rager-endurance", "mounted-fury-mounts", "bard-versatile-performances", "detective-arcane-investigation", "cleric-deities", "cleric-alignments", "cleric-channel-energy", "cleric-domains", "druid-nature-bonds", "oracle-mysteries", "oracle-curses", "oracle-cure-inflict", "oracle-revelations", "paladin-mercies", "paladin-divine-bonds", "ranger-favored-enemies", "ranger-combat-styles", "ranger-combat-style-feats", "ranger-favored-terrains", "ranger-hunters-bonds", "ranger-animal-companions", "sorcerer-bloodlines", "wizard-arcane-bonds", "wizard-familiars", "wizard-bonded-objects", "wizard-schools", "wizard-opposition-schools", "rogue-talents", "combat-feats", "fighter-weapon-groups"]);
