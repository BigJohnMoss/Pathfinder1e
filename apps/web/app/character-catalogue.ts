...
export const classes = orderedById<CharacterClass>(generatedData.classes, ["arcanist", "barbarian", "cleric", "fighter", "monk", "paladin", "ranger", "rogue", "sorcerer", "wizard"]);
