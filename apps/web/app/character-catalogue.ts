...
export const classes = orderedById<CharacterClass>(generatedData.classes, ["arcanist", "barbarian", "bard", "cleric", "fighter", "monk", "paladin", "ranger", "rogue", "sorcerer", "wizard"]);
