...
const preferredOptionGroupOrder = ["arcanist-exploits", "rage-powers", "brutal-pugilist-maneuvers", "invulnerable-rager-endurance", "mounted-fury-mounts", "bard-versatile-performances", "detective-arcane-investigation", "magician-expanded-repertoire", "magician-bonded-objects", "sea-singer-familiars", "cleric-deities", "cleric-alignments", "cleric-channel-energy", "cleric-domains", "druid-nature-bonds", "blight-druid-nature-bonds", "blight-druid-familiars", "urban-druid-nature-bonds", "four-winds-aspects", "oracle-mysteries", "oracle-curses", "oracle-cure-inflict", "oracle-revelations", "paladin-mercies", "paladin-divine-bonds", "ranger-favored-enemies", "ranger-combat-styles", "ranger-combat-style-feats", "ranger-favored-terrains", "ranger-hunters-bonds", "ranger-animal-companions", "ranger-shifter-forms", "ranger-hunter-tricks", "ranger-infiltrator-adaptations", "sorcerer-bloodlines", "wizard-arcane-bonds", "wizard-familiars", "wizard-bonded-objects", "wizard-schools", "wizard-opposition-schools", "rogue-talents", "combat-feats", "fighter-weapon-groups"];
const preferredOptionGroupIds = new Set(preferredOptionGroupOrder);
export const optionGroups = [
  ...orderedById<CharacterOptionGroup>(generatedData.optionGroups, preferredOptionGroupOrder),
  ...generatedData.optionGroups.filter(group => !preferredOptionGroupIds.has(group.id)).sort((left, right) => left.name.localeCompare(right.name))
