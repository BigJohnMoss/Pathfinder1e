...
export default function Home() {
  ...
  const skillCharacterClass = useMemo(() => selectedBloodline?.classSkill
    ? { ...characterClass, classSkills: bloodlineClassSkills(characterClass.classSkills, selectedBloodline) }
    : characterClass, [characterClass, selectedBloodline]);
  ...
  const bloodlineSpellIds = useMemo(() => classId === "sorcerer" ? bloodlineBonusSpells(availableSpells, selectedBloodline, level).map((spell) => spell.id) : [], [availableSpells, classId, level, selectedBloodline]);
