...
import { abilityNames, availableOptions, characterCombatStats, classProgression, featPrerequisiteResults, skillTotal, spellsAvailableToClass } from "../../../packages/engine/src/index.js";
...
export default function Home() {
  ...
  return <main>
    ...
    <section className="builder" aria-label="Character details">
      ...
      <div><button type="button" onClick={saveCharacter}>Save</button><button type="button" onClick={loadCharacter}>Load</button><button type="button" onClick={exportCharacter}>Export</button><button type="button" onClick={resetCharacter}>Reset</button><small>{saveNotice}</small></div>
    </section>
