...
export default function Home() {
  ...
  const featContext = useMemo(() => ({ classId: characterClass.id, ancestryId, classLevel: level, casterLevel: "spellcasting" in characterClass ? level : 0, abilities, baseAttackBonus: progression.baseAttackBonus, skillRanks, featureIds: progression.features.map((feature) => feature.id), selectedFeatChoices }), [abilities, ancestryId, characterClass, level, progression.baseAttackBonus, progression.features, selectedFeatChoices, skillRanks]);
