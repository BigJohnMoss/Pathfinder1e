...
export default function Home() {
  ...
  const spellcastingClassIds = useMemo(() => [hasSpellcasting ? characterClass.id : "", secondaryHasSpellcasting && secondaryCharacterClass ? secondaryCharacterClass.id : ""].filter(Boolean), [characterClass.id, hasSpellcasting, secondaryCharacterClass, secondaryHasSpellcasting]);
