...
export default function Home() {
  ...
  const saveCharacter = () => { localStorage.setItem("pf1e-character-draft", JSON.stringify({ name, classId, level, humanAbility, baseAbilities, selectedFeatIds, skillRanks, selectedOptions, preparedSpells, spellSlotUses, arcaneReservoir: reservoirPoints })); setSaveNotice("Saved locally"); };
