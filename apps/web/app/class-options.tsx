...
export function ClassOptions({ choices, selectedOptions, classLevel, charismaModifier, archetypeReplacesText = "", onOptionChange }: { choices: Choice[]; selectedOptions: Record<string, string>; classLevel: number; charismaModifier: number; archetypeReplacesText?: string; onOptionChange: (featureId: string, optionId: string) => void }) {
