...
export function ClassOptions({ choices, selectedOptions, classLevel, charismaModifier, abilityModifiers = {}, dailyResources = [], archetypeReplacesText = "", onOptionChange, onAddEffect }: { choices: Choice[]; selectedOptions: Record<string, string>; classLevel: number; charismaModifier: number; abilityModifiers?: Partial<Record<AbilityName, number>>; dailyResources?: DailyResource[]; archetypeReplacesText?: string; onOptionChange: (featureId: string, optionId: string) => void; onAddEffect?: (effect: ActiveEffect) => void }) {
