...
export function CombatPanel({ combat, landSpeed, senses = [], defenses = [], modifierSources = [], conditionalModifiers = [] }: {
  ...
  defenses?: Array<{ kind: "damageReduction" | "energyResistance" | "spellResistance" | "immunity" | "evasion" | "improvedEvasion" | "uncannyDodge" | "improvedUncannyDodge" | "fortification" | "concealment" | "missChance" | "fastHealing"; value: number; qualifier: string; condition?: string; source: string }>;
