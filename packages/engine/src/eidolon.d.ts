...
export function validateEidolonEvolutions(selectedIds:string[],evolutions:EidolonEvolution[],level:number,baseFormId:string):{selectedIds:string[];spent:number;remaining:number;pool:number};
