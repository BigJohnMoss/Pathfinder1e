...
function prerequisiteMet(prerequisite, context) {
  ...
  if (prerequisite.type === "choice-value") return context.selectedFeatChoices?.[prerequisite.featId]?.trim().toLocaleLowerCase() === prerequisite.value.trim().toLocaleLowerCase();
