...
export function mysteryBonusSpells(spells: CharacterSpell[], selectedMystery: CharacterOption | null | undefined, oracleLevel: number, classId?: string): CharacterSpell[];
