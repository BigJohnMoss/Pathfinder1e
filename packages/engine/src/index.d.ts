...
export function traitBonuses(selectedTraitIds: string[], traits: CharacterTrait[], selectedTraitChoices?: Record<string, string>, sources?: { spells?: Array<{ id: string; levelByClass?: Record<string, number> }>; classId?: string }): { initiative: number; saves: Record<"fortitude" | "reflex" | "will", number>; skillBonuses: Record<string, number>; classSkills: string[]; spellBonuses?: Record<string, { casterLevel: number; metamagicLevelAdjustment: number }> };
