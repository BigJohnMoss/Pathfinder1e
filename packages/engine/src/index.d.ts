...
export function inferredArchetypeSpellAccessDetails(archetype?: CharacterArchetype, spells?: CharacterSpell[]): { spellListAdditions: Record<string, number>; spellListExclusions: string[]; sourceFeatureIds: Set<string>; fullyAutomatedFeatureIds: Set<string> };
